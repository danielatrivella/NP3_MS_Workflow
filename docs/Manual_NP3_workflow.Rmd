...
The top k may also be used to filter the final view, in this case the most novelty samples - the ones with more exclusive and not annotated m/z - are selected for the final plots. The novelty here is measured as a m/z that is not present in any library search and the samples that have a list of m/z that were not detected in other samples - which are exclusive to this sample.
