...
Furthermore, the user can manually identify the resulting consensus spectra against the GNPS [8] spectral libraries and use another separated command of this workflow called **gnps_result** to join the GNPS identification results to the $NP^{3}$ MS workflow quantification tables.
...
##### 4.12.4. *gnps_result* Identification Curation and UNPDxGNPS Best Origin
...
##### 4.15.1. *spectra_viewer* Examples:
