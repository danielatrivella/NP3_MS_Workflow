...
- The 'molecular_networking' folder containing: 
    ...
    - Three molecular networks edge files (Steps 7 and 10): 
        - the molecular network of annotations named as '\<*output_name*\>_ivamn.selfloops'
        - the complete molecular network of similarity named as '\<*output_name*\>_ssmn_w_\<*similarity_mn*\>.selfloops', all links with a similarity value above the cut-off are present
