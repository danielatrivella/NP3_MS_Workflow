...
The GNPS2 Library Search workflow was adapted and integrated to the $NP^{3}$ MS Workflow. All LC libraries, aggregated in the ALL_GNPS_NO_PROPOGATED library (https://external.gnps2.org/gnpslibrary), are used in this routine. It's MGF is retrieved locally in the *setup* command and enriched with online annotations previous organized from April 2026. This annotations will be updated with GNPS2 online data from time to time by the admins of this repository. 
