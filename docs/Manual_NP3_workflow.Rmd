...
After the biocorrelation computations, this command computes the grouping of the quantification defined in the metadata table (column named with prefix "GR_"). These groups may be used to aggregate any characteristics of the samples.
