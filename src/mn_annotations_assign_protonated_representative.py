...
def loading_direct_network(edges_file, remove_selfloops=False):
	...
	# create a directed graph from edges list and remove selfloops if wanted
	G = nx.DiGraph()
...
def mn_annotation_find_protonated(mn_annotation_edges_file, nodes_filename):
	...
	# create directed graph from edges list and remove selfloops
	G = loading_direct_network(mn_annotation_edges_file, remove_selfloops=True)
